...
*/
    var getResult = function( userChoice, computerChoice ){
        ...
        document.querySelector('#computerGame').innerHTML = `
            <img src="./img/${computerChoice}.svg" alt="Pierre">
        `;
        ...
        if( userChoice === computerChoice ){
            ...
            document.querySelector('#computerGame').innerHTML += '<p>Gagné !</p>';
            ...
            document.querySelector('#computerGame').innerHTML += '<p>Perdu...</p>';
